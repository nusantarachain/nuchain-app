...
import 'package:polkawallet_plugin_nuchain_example/pages/assetsContent.dart';
import 'package:polkawallet_plugin_nuchain_example/pages/profileContent.dart';
import 'package:polkawallet_plugin_nuchain_example/pages/selectListPage.dart';
...
import 'package:polkawallet_plugin_nuchain_example/pages/homePage.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      title: 'Polkawallet Plugin Nuchain Demo',
