...
class _StakingActions extends State<StakingActions>
        ...
        child: ListTile(
          leading: Container(
            ...
            child: i.eventId == 'Reward'
                ? SvgPicture.asset(
                    'packages/polkawallet_plugin_nuchain/assets/images/staking/reward.svg')
                : SvgPicture.asset(
                    'packages/polkawallet_plugin_nuchain/assets/images/staking/slash.svg'),
          ),
          title: Text(i.eventId),
          subtitle: Text(Fmt.dateTime(
              DateTime.fromMillisecondsSinceEpoch(i.blockTimestamp))),
  ...
  Widget _buildActionCard() {
    var dic = I18n.of(context).getDic(i18n_full_dic_nuchain, 'staking');
...
class StakingInfoPanel extends StatelessWidget {
  ...
  void _showUnlocking(BuildContext context) {
    final dic = I18n.of(context).getDic(i18n_full_dic_nuchain, 'staking');
    final dicGov = I18n.of(context).getDic(i18n_full_dic_nuchain, 'gov');
      ...
      builder: (BuildContext context) => CupertinoActionSheet(
        ...
        cancelButton: CupertinoActionSheetAction(
          child: Text(I18n.of(context)
              .getDic(i18n_full_dic_nuchain, 'common')['cancel']),
          onPressed: () {
            Navigator.pop(context);
          },
        ),
