...
import 'package:polkawallet_plugin_nuchain/pages/governance/treasury/spendProposals.dart';
import 'package:polkawallet_plugin_nuchain/pages/governance/treasury/tips.dart';
...
class _TreasuryPageState extends State<TreasuryPage> {
  ...
  Widget build(BuildContext context) {
    var dic = I18n.of(context).getDic(i18n_full_dic_nuchain, 'gov');
