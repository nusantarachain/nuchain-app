...
class _CouncilState extends State<Council> {
  ...
  Future<void> _submitCancelVotes() async {
    final govDic = I18n.of(context).getDic(i18n_full_dic_nuchain, 'gov');
      ...
      builder: (BuildContext context) {
        return CupertinoAlertDialog(
          ...
          content: Text(I18n.of(context)
              .getDic(i18n_full_dic_nuchain, 'gov')['vote.remove.confirm']),
          actions: [
            CupertinoButton(
  ...
  Widget build(BuildContext context) {
    return ListTile(
      ...
      subtitle: balance.length == 1
          ? null
          : Text(
              '${I18n.of(context).getDic(i18n_full_dic_nuchain, 'gov')['backing']}: ${Fmt.token(
