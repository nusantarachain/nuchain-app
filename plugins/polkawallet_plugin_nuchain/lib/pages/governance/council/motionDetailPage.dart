...
import 'package:polkawallet_plugin_nuchain/pages/governance/council/council.dart';
...
class _MotionDetailPageState extends State<MotionDetailPage> {
  ...
  Widget build(BuildContext context) {
    final Map dic = I18n.of(context).getDic(i18n_full_dic_nuchain, 'gov');
    final CouncilMotionData motion = ModalRoute.of(context).settings.arguments;
    return Observer(
      ...
      GestureDetector(
        child: Row(
          children: <Widget>[
            ...
            Text(I18n.of(context).getDic(i18n_full_dic_nuchain, 'gov')['detail'])
          ],
        ),
        onTap: () {
          setState(() {
