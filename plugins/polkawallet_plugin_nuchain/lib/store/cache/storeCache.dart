...
const String plugin_nuchain_storage_key = 'plugin_nuchain';
const String plugin_polkadot_storage_key = 'plugin_polkadot';

abstract class StoreCache {
  static final _storage = () => GetStorage(plugin_nuchain_storage_key);
...
class StoreCacheNuchain extends StoreCache {
  static final _storage = () => GetStorage(plugin_nuchain_storage_key);
