        ...
        actions: <Widget>[
          CupertinoActionSheetAction(
            ...
            onPressed: () {
              ...
              final snLink =
                  'https://scan.nuchain.network/account/${widget.service.keyring.current.address}';
              UI.launchURL(snLink);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: Observer(
          builder: (_) {
            BigInt balance = widget.service.plugin.balances == null ? BigInt.zero : (widget.service.plugin.balances.native != null ?
                Fmt.balanceTotal(widget.service.plugin.balances.native) : BigInt.zero);
...
class TransferListItem extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    String amountFormatted = Fmt.priceFloorBigInt(Fmt.balanceInt(data.amount), 10, lengthMax: 4);
    return Container(
